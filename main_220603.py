...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Searchbutton.place(x=545,y=410)
        Historybutton.place(x=545,y=475)
        closebutton.place(x=545,y=540)
        teamlabel.place(x=1200,y=590)
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        SearchPhoto = tk.PhotoImage(file="SearchPhoto.png")
        Searchbutton = tk.Button(self, image = SearchPhoto, background=controller.backcolor)
        Searchbutton.image = SearchPhoto
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ##db 텍스트 상자
        textbox2 = tk.Text(self, width=30, height=20,font=("System", 30))   ###
